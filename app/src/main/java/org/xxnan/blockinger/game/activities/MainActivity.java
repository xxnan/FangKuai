...
import org.xxnan.blockinger.game.db.HighscoreOpenHelper;
import org.xxnan.blockinger.game.db.ScoreDataSource;
...
public class MainActivity extends ListActivity {
	 ...
	 */
	public static final String PLAYERNAME_KEY = "org.xxnan.blockinger.game.activities.playername";
	
	/** This key is used to access the player name, which is returned as an Intent from the gameactivity upon completion (gameover).
	 *  The Package Prefix is mandatory for Intent data
	 */
	public static final String SCORE_KEY = "org.xxnan.blockinger.game.activities.score";
