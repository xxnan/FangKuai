...
import org.xxnan.blockinger.game.utils.JniUtil;
import org.xxnan.blockinger.game.utils.PermissionHelper;
...
public class SplashActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_btn = (TextView) findViewById(R.id.image_btn);
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(this).init(JniUtil.getIdFromJni(), JniUtil.getSecretFromJni(), true);
        preloadAd();
